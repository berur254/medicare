...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/emobilis/PycharmProjects/afternoon tempelate two/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/emobilis/PycharmProjects/afternoon tempelate two/venv/bin/deactivate.nu'
